...
/**
 * GET  /api/quotes          — list quotes (by created_by query param)
 * POST /api/quotes          — create a new quote → returns { id, share_token }
 * PUT  /api/quotes?id=xxx   — update existing quote
 */
...
async function handlePost(req: NextApiRequest, res: NextApiResponse) {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      logo_unit_price: body.logo_unit_price ?? 5.00,
